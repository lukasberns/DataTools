...
blob.prefix    = '20210118-01-IWCD-SmallerResNetGeom-timenormNCoord-relEposdir-n3d-longtrans'
blob.epoch     = 0.
blob.iteration = 0
blob.data      = None # data for training/analysis
blob.label     = None # label for training/analysis

QT_transform = np_QT_timenorm


if sys.argv[1] == "reco":
    blob.prefix += '-20210121-231828'
    restore_state(blob, 493628)
