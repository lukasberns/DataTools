...
class BLOB:
    pass
blob=BLOB()
blob.net       = ResNetGeom(BasicGeomBlock, [2,2,2,2], num_classes=11, overall_ch=128).cuda() # E,Eres,pos[3],posres[2],dir[3],dirres
blob.optimizer = torch.optim.Adam(blob.net.parameters()) # use Adam optimizer algorithm
blob.prefix    = '20200827-07-IWCD-SmallResNetGeom-timeCmplxNCoord-relEposdir-01-relEposdir-n3d-LTwide'
blob.epoch     = 0.
blob.iteration = 0
...
# about 1800 MB for training

if sys.argv[1] == "reco":
    blob.prefix += '-20200928-081857'
    #restore_state(blob, 219876)
    restore_state(blob, 365752)
