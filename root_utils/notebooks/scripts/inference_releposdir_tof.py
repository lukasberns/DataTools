...
def inferenceWithSoftmax(blob,data_loader):
    label,simple_position,simple_logSigmaPosSqr,pred_Eabovethres,pred_logSigmaESqr,pred_position,pred_logSigmaPosSqr,pred_direction,pred_logSigmaDirSqr,positions,directions,energies=[],[],[],[],[],[],[],[],[],[],[],[]
    ...
    for i,data in enumerate(data_loader):
        ...
        simple_position.append(res['pred_simple_position'])
        simple_logSigmaPosSqr.append(res['pred_simple_positionres'])
        ...
        #if i==2: break
    # report accuracy
    simple_position       = np.vstack(simple_position)
    simple_logSigmaPosSqr = np.vstack(simple_logSigmaPosSqr)
    ...
    return simple_position, simple_logSigmaPosSqr, pred_Eabovethres, pred_logSigmaESqr, pred_position, pred_logSigmaPosSqr, pred_direction, pred_logSigmaDirSqr, label, positions, directions, energies
