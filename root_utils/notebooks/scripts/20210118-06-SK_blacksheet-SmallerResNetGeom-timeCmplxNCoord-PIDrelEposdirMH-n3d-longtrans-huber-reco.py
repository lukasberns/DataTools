...
blob.prefix    = '20210118-06-SK_blacksheet-SmallResNetGeom-timeCmplxNCoord-PIDrelEposdirMH-01-relEposdir-n3d-longtrans-huber'
blob.epoch     = 0.
blob.iteration = 0
...
pnameset = "e-mu-"
batches = np.arange(100)+1
mcdir = '/home/lukasb/watchmal/data_ssd/20210221-uniisoflat/h5_topo/1R-blacksheet'
filespattern = '%(mcdir)s/%(pname)s/wc-0-bch%(bch)d.h5'
outdirpattern = '/home/lukasb/watchmal/data/20210221-uniisoflat/reco_%s'
outfilepattern = '%(outdir)s/%(pname)s/wc-0-bch%(bch)d.h5'

if sys.argv[1] == "reco":
    blob.prefix += '-20210320-113616'
    restore_state(blob, 674750) # epoch 23
    ...
    blob.prefix += '-20210320-113616'
    print(blob.prefix)
    restore_state(blob, 337375) # epoch 12
    TRAIN_EPOCH = 40.0
    execfile(os.path.dirname(__file__)+'/train.py')
